...
export class IndexApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async partialReplace(table: string, id: number, replaceDocumentRequest: ReplaceDocumentRequest, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'table' is not null or undefined
        if (table === null || table === undefined) {
            throw new RequiredError("IndexApi", "partialReplace", "table");
        }
        ...
        // Path Params
        const localVarPath = '/{table}/_update/{id}'
