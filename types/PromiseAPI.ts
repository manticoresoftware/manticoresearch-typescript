...
export class PromiseIndexApi {
     ...
     */
    public partialReplaceWithHttpInfo(table: string, id: number, replaceDocumentRequest: ReplaceDocumentRequest, _options?: Configuration): Promise<HttpInfo<UpdateResponse>> {
        const result = this.api.partialReplaceWithHttpInfo(table, id, replaceDocumentRequest, _options);
        return result.toPromise();
    }
     ...
     * @param replaceDocumentRequest
     */
    public partialReplace(table: string, id: number, replaceDocumentRequest: ReplaceDocumentRequest, _options?: Configuration): Promise<UpdateResponse> {
        const result = this.api.partialReplace(table, id, replaceDocumentRequest, _options);
        return result.toPromise();
    }
...
export class PromiseSearchApi {
     ...
     */
    public autocompleteWithHttpInfo(autocompleteRequest: AutocompleteRequest, _options?: Configuration): Promise<HttpInfo<Array<any>>> {
        const result = this.api.autocompleteWithHttpInfo(autocompleteRequest, _options);
        return result.toPromise();
    }
     ...
     * @param autocompleteRequest
     */
    public autocomplete(autocompleteRequest: AutocompleteRequest, _options?: Configuration): Promise<Array<any>> {
        const result = this.api.autocomplete(autocompleteRequest, _options);
        return result.toPromise();
    }
     ...
     */
    public percolateWithHttpInfo(table: string, percolateRequest: PercolateRequest, _options?: Configuration): Promise<HttpInfo<SearchResponse>> {
        const result = this.api.percolateWithHttpInfo(table, percolateRequest, _options);
        return result.toPromise();
    }
     ...
     * @param percolateRequest
     */
    public percolate(table: string, percolateRequest: PercolateRequest, _options?: Configuration): Promise<SearchResponse> {
        const result = this.api.percolate(table, percolateRequest, _options);
        return result.toPromise();
    }
