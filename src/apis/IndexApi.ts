...
export class IndexApi extends runtime.BaseAPI {
  ...
  async bulkRaw(
    ...
    if (requestParameters.body === null || requestParameters.body === undefined) {
      throw new runtime.RequiredError(
        'body',
        'Required parameter requestParameters.body was null or undefined when calling bulk.',
      );
    }
  ...
  async deleteRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<DeleteResponse>> {
    if (requestParameters.deleteDocumentRequest === null || requestParameters.deleteDocumentRequest === undefined) {
      throw new runtime.RequiredError(
        'deleteDocumentRequest',
        'Required parameter requestParameters.deleteDocumentRequest was null or undefined when calling delete.',
      );
    }
  ...
  async insertRaw(
    ...
    if (requestParameters.insertDocumentRequest === null || requestParameters.insertDocumentRequest === undefined) {
      throw new runtime.RequiredError(
        'insertDocumentRequest',
        'Required parameter requestParameters.insertDocumentRequest was null or undefined when calling insert.',
      );
    }
   ...
   */
  async replaceRaw(
    requestParameters: ReplaceRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<SuccessResponse>> {
    if (requestParameters.insertDocumentRequest === null || requestParameters.insertDocumentRequest === undefined) {
      throw new runtime.RequiredError(
        'insertDocumentRequest',
        'Required parameter requestParameters.insertDocumentRequest was null or undefined when calling replace.',
      );
    }
  ...
  async updateRaw(
    ...
    if (requestParameters.updateDocumentRequest === null || requestParameters.updateDocumentRequest === undefined) {
      throw new runtime.RequiredError(
        'updateDocumentRequest',
        'Required parameter requestParameters.updateDocumentRequest was null or undefined when calling update.',
      );
    }
