...
import type { ErrorResponse, PercolateRequest, SearchRequest, SearchResponse } from '../models/index';
...
export class SearchApi extends runtime.BaseAPI {
   ...
   */
  async percolateRaw(
    requestParameters: PercolateOperationRequest,
    ...
    if (requestParameters.index === null || requestParameters.index === undefined) {
      throw new runtime.RequiredError(
        'index',
        'Required parameter requestParameters.index was null or undefined when calling percolate.',
      );
    }
    ...
    if (requestParameters.percolateRequest === null || requestParameters.percolateRequest === undefined) {
      throw new runtime.RequiredError(
        'percolateRequest',
        'Required parameter requestParameters.percolateRequest was null or undefined when calling percolate.',
      );
    }
  ...
  async searchRaw(
    ...
    if (requestParameters.searchRequest === null || requestParameters.searchRequest === undefined) {
      throw new runtime.RequiredError(
        'searchRequest',
        'Required parameter requestParameters.searchRequest was null or undefined when calling search.',
      );
    }
